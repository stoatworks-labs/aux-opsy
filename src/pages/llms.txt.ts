...
export const GET: APIRoute = () => {
  ...
  const lines: string[] = [
    ...
    '> architecture of digital mixing consoles, published by Stoatworks Labs.',
    '> Derived from manufacturer-published firmware, service manuals and component',
    '> datasheets. No console has ever been opened, connected to or modified.',
    '',
    ...
    '',
    'Two of the teardowns reached a negative result — the platform cannot host',
